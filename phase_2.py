# in phase 2 we'll rotate the car by 90 degrees right

# earlier we were detecting only y axis, now we' ll detect x axis as well
...
# one thing you might miss out, that is -> camera's position. So we have an offset this offset will readjust it.
        cam_offset = 30
        # transformation takes two args, object and angle, clockwise is denoted by -ve sign
