...
# earlier we were detecting foward backward, backward and right and left turns. However up and right together are not there
...
# turning up when current direction is right
